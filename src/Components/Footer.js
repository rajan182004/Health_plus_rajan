    ...
    <div className="footer-section">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <ul className="ft-list-items">
            ...
            <li>
              <a href="tel:+91 7870986101">+91 7870986101</a>
            </li>
            <li>
              <a href="tel:+91 7870986102">+91 7870986102</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="ft-copyright">
        ...
        <ul className="ft-social-links">
          <li>
            <a
              href="https://www.linkedin.com/in/rajan-gupta-23892114a/"
              title="LinkedIn"
              target="_blank"
          ...
          <li>
            <a
              href="https://www.facebook.com/profile.php?id=100066810755500"
              title="FaceBook"
              target="_blank"
              rel="noopener noreferrer"
            >
